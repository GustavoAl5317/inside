...
export type InteratellCompany = {
  ...
  /** Contato que sai no bloco da Interatell da planilha e no PDF. */
...
export const INTERATELL_COMPANIES: Record<'matriz' | 'filial', InteratellCompany> = {
  matriz: {
    ...
    zipCode: "06472-001", city: "Barueri", state: "SP",
    neighborhood: "Empresarial 18 do Forte", address: "Avenida Copacabana",
    number: "190", complement: "Conj. 201",
    contactName: "Gabriella Amaro", phone: "(11) 3303-3324",
    email: "financeiro@interatell.com.br",
  },
  filial: {
    cnpj: "03969530000211",
    name: "INTERATELL INTEGRACOES E TELECOMUNICACOES LTDA",
    stateRegistration: "084000449",
    zipCode: "29175-706", city: "Serra", state: "ES",
